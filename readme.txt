...
For more information about Twenty Sixteen Ex please go to https://codex.wordpress.org/Twenty_Sixteen.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Twenty Sixteen Ex in the search form and press the 'Enter' key on your keyboard.
...
Twenty Sixteen Ex WordPress Theme, Copyright 2014-2015 WordPress.org
Twenty Sixteen Ex is distributed under the terms of the GNU GPL
...
Twenty Sixteen Ex Theme bundles the following third-party resources:
